...
HOLO_FUSION_DML_WRITE_MAX_BATCH_ENTRIES="${HOLO_FUSION_DML_WRITE_MAX_BATCH_ENTRIES:-2048}"
HOLO_FUSION_DML_WRITE_MAX_BATCH_BYTES="${HOLO_FUSION_DML_WRITE_MAX_BATCH_BYTES:-4194304}"
